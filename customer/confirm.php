...
<body>
	  ...
	  <table width="500" align="center" border="2" bgcolor="#cccccc">
		...
		<option>Easypaisa/UBL Omno</option>
		...
		<td align="right">Trasaction/Refference ID: </td>
...
{   $update_id=$_GET['update_id'];
	...
	{
	echo "<h2 style='text-align:center; color:blue;'>Payment recieved, Your order will be completed within 24 hours</h2>";
}
